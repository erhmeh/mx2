...
typedef union
{
    struct  // Status Entry
    {
        ...
        UINT8 spare:   2;
        #endif
        UINT8 TOK_PID: 4;  // Packit Identifier
        UINT8 DAT01:   1;  // Data-toggle bit
        UINT8 UOWN:    1;  // Descriptor owner: 0=SW, 1=HW
        #if !defined(__18CXX) && !defined(__XC8)
        UINT8 resvd:   8;
        #endif
     };
    ...
    struct  // Setup Entry
    {
        ...
        UINT8 spare:   2;
        #endif
        UINT8 BSTALL:  1;  // Stalls EP if this descriptor needed
        UINT8 DTS:     1;  // Require data-toggle sync
        UINT8 NINC:    1;  // No Increment of DMA address
        UINT8 KEEP:    1;  // HW Keeps this buffer & descriptor
        UINT8 DAT01:   1;  // Data-toggle number (0 or 1)
        UINT8 UOWN:    1;  // Descriptor owner: 0=SW, 1=HW
        #if !defined(__18CXX) && !defined(__XC8)
        UINT8 resvd:   8;
        #endif
...
typedef union
{
    ...
    struct  // Byte-count field
    {
        UINT8 BC:      10; // Number of bytes in data buffer
        UINT8 resvd:   6;
    };
    #endif
